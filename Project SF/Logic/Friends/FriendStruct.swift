...
struct Friend: Hashable {
    ...
    init(username: String, name: String, bio: String, profilePictureURL: String, activityRings: ActivityRings? = nil, publicUserRecordID: CKRecord.ID? = nil, privateUserRecordID: CKRecord.ID) {
